...
# A NAT Gateway costs money per hour.

# If you are on Free Tier, I suggest:

#  Remove NAT for now
#  Use public subnets for ECS temporarily
#  Add NAT later for “production version”
